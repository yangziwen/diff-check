 ...
 */
package io.github.yangziwen.pmd.cli;
...
import io.github.yangziwen.pmd.PMDConfiguration;
...
public class PMDParameters {
    ...
    @Parameter(names = { "-git-dir", "-gd" }, description = "Git directory for sources, 'dir' and 'filelist' options will be ignored if this option is specified.")
    ...
    public boolean isIncludeStagedCodes() {
